...
const AdoptableModal = ({ isOpen, onClose, adoptable }) => {
  ...
  // Determine if current user is a Shelter
          ...
          >
            <div className="bg-white px-6 pb-4 rounded-2xl w-full max-w-5xl max-h-[90vh] overflow-y-auto relative flex flex-col z-50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
                ...
                {/* Right Side: Pet & Shelter Details (Aligned to Image) */}
                <div className="flex flex-col justify-between h-full">
                  ...
                  {/* Tags Section */}
                  {adoptable.tags && adoptable.tags.length > 0 && (
                    <div className="mt-4">
                      <h3 className="text-sm font-semibold mb-2">Tags</h3>
                      <div className="flex flex-wrap gap-2">
                        {adoptable.tags.map((tag, index) => (
                  ...
                  {/* Shelter Info (Retains Original Color) */}
                  <div className="px-4 py-4 rounded-xl mt-4 bg-hoverColor">
