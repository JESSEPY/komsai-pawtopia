...
// Hooks
import { useAdoptedPetsById } from "../../../../hooks/useAdoptedPets";
import { useUserLostPetPostsById } from "../../../../hooks/useUserLostPetPosts";
import { useUserCommentsById } from "../../../../hooks/useUserComments";
...
const OverviewCombined = () => {
  ...
  // ✅ Fetch user-specific data using new hooks
  const {
    lostPets,
    isLoading: isLostLoading,
    isError: isLostError,
  } = useUserLostPetPostsById(userId);
  const {
    data: adoptedPets,
    isLoading: isAdoptedLoading,
    error: adoptedError,
  } = useAdoptedPetsById(userId);
  const {
    comments,
    isLoading: isCommentsLoading,
    isError: isCommentsError,
  } = useUserCommentsById(userId);
  ...
  const sortedData = useMemo(() => {
    ...
    // Prioritize: AdoptableCard (always on top), then FindCard with `lostStatus: "resolved"`, then everything else sorted by timestamp
  ...
  console.log(`Overview Combined Data for User ${userId}:`, sortedData);
